...
- Implementação do **Jetpack Compose** para o novo fluxo de CNH Digital.
  ...
  > ⚠️ **Atenção**: Esta versão requer que o projeto tenha Jetpack Compose configurado. Projetos que não utilizam Compose precisarão adicionar a configuração mínima. Consulte o [guia de migração](BREAKING_CHANGES_7.0.0.md) para mais detalhes.
